...
@WebServlet("/car/payment/creditCard")
public class CarCreditCardController extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			req.getRequestDispatcher("/WEB-INF/views/payment/CarCreditCard.jsp").forward(req, resp);
		}catch (Exception e) {
